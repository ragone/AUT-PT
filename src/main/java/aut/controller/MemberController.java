...
public class MemberController implements Initializable {
    ...
    private void editHealthCheckAction(ActionEvent event) {
        ...
        if(hc != null) {
            Parent root;
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/healthCheck.fxml"));
    ...
    public void editProgramAction(ActionEvent actionEvent) {
        ...
        Parent root;
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/program.fxml"));
            root = fxmlLoader.load();
    ...
    private void save(ActionEvent event) {
        ...
        HibernateUtil.saveUpdateObject(member);
